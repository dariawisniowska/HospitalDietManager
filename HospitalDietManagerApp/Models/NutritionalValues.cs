...
namespace HospitalDietManagerApp.Models
{
    public class NutritionalValues
    {
        ...
        public NutritionalValues(double energia, double bialko, double tluszcze, double weglowodany, double sod, double tluszcze_nn, double weglowodany_przyswajalne, double blonnik)
        {
