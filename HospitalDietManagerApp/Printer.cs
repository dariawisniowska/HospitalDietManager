...
namespace HospitalDietManagerApp
{
    ...
    {
        public static bool wszystko = false;
        public static void Receptura(Recepie receptura)
        {
            try
            {
        ...
        public static void Produkt(Product produkt)
        {
            try
            {
        ...
        public static void Jadlospis(Menu jadlospis)
        {
            try
            {
                if (wszystko)
                    ...
                    if (jadlospis != null)
                    {
                        ...
                        using (DocX document = DocX.Create(path))
                        {
...

                            {
                                ...
                                Paragraph p2 = document.InsertParagraph();
                                p2.Alignment = Alignment.left;
                                Table t = document.AddTable(rows, cl - 2);
                                t.Alignment = Alignment.center;
                                t.SetBorder(TableBorderType.Bottom, new Border(Xceed.Words.NET.BorderStyle.Tcbs_single, BorderSize.one, 1, Color.Black));
                                t.SetBorder(TableBorderType.InsideH, new Border(Xceed.Words.NET.BorderStyle.Tcbs_single, BorderSize.one, 1, Color.Black));
                                t.SetBorder(TableBorderType.InsideV, new Border(Xceed.Words.NET.BorderStyle.Tcbs_single, BorderSize.one, 1, Color.Black));
                               ...
                               .Color(Color.Black);
                                ...
                                for (int i = 0; i < cl; i++)
                                {
                                    if (naglowki[i] != "Kwasy tłuszczowe nasycone [g]" && naglowki[i] != "Sód [mg]")
                                    {
                                        if (i + licznik <= cl)
                                            t.Rows[0].Cells[i + licznik].Paragraphs[0].Append(naglowki[i])
                                                .Font("Times New Roman")
                                                .FontSize(9)
                                                .Color(Color.Black);
                                    }
                                ...
                                for (int r = 0; r < rows - 2; r++)
                                {
                                    ...
                                    if (dane[0] != "")
                                    {
                                        for (int c = 0; c < cl; c++)
                                        {
                                            if (naglowki[c] != "Kwasy tłuszczowe nasycone [g]" && naglowki[c] != "Sód [mg]")
                                            {
                                                if (c == 0)
                                                    t.Rows[r + 1].Cells[c + licznik].Paragraphs[0].Append(dane[c])
                                                        .Font("Times New Roman")
                                                        .FontSize(9)
                                                        .Color(Color.Black);
                                                else
                                ...
                                {
                                    if (i + licznik + 2 < t.Rows[rows - 1].Cells.Count)
                                    {
                                        if (naglowki[i + 2] != "Kwasy tłuszczowe nasycone [g]" && naglowki[i + 2] != "Sód [mg]")
                                        {
                                            t.Rows[rows - 1].Cells[i + licznik + 2].Paragraphs[0].Append(sum[i].ToString())
                                                    .Font("Times New Roman")
                                                 .FontSize(9)
                                                .Color(Color.Black);
                                        }
                            ...
                            if (jadlospis.sklad_IIsniadanie != "")
                            {
                                ...
                                Paragraph p2 = document.InsertParagraph();
                                p2.Alignment = Alignment.left;
                                Table t = document.AddTable(rows, columns - 2);
                                t.SetBorder(TableBorderType.Bottom, new Border(Xceed.Words.NET.BorderStyle.Tcbs_single, BorderSize.one, 1, Color.Black));
                                t.SetBorder(TableBorderType.InsideH, new Border(Xceed.Words.NET.BorderStyle.Tcbs_single, BorderSize.one, 1, Color.Black));
                                t.SetBorder(TableBorderType.InsideV, new Border(Xceed.Words.NET.BorderStyle.Tcbs_single, BorderSize.one, 1, Color.Black));
                                t.SetBorder(TableBorderType.Left, new Border(Xceed.Words.NET.BorderStyle.Tcbs_single, BorderSize.one, 1, Color.Black));
                                ...
                                for (int i = 0; i < columns - 2; i++)
                                {
                                    if (i + licznik + 2 < t.Rows[rows - 1].Cells.Count)
                                    {
                                        if (naglowki[i + 2] != "Kwasy tłuszczowe nasycone [g]" && naglowki[i + 2] != "Sód [mg]")
                                        {
                                            t.Rows[rows - 1].Cells[i + licznik + 2].Paragraphs[0].Append(suma2[i].ToString())
                                                    .Font("Times New Roman")
                                                 .FontSize(9)
                                                .Color(Color.Black);
                                        }
                            ...
                            Table t2 = document.AddTable(2, columns2 - 2 - 2);
                            t2.Alignment = Alignment.center;
                            t2.SetBorder(TableBorderType.Bottom, new Border(Xceed.Words.NET.BorderStyle.Tcbs_single, BorderSize.one, 1, Color.Black));
                            t2.SetBorder(TableBorderType.InsideH, new Border(Xceed.Words.NET.BorderStyle.Tcbs_single, BorderSize.one, 1, Color.Black));
                            t2.SetBorder(TableBorderType.InsideV, new Border(Xceed.Words.NET.BorderStyle.Tcbs_single, BorderSize.one, 1, Color.Black));
                            ...
                            {
                                if (i + licznik2 < t2.Rows[0].Cells.Count)
                                {
                                    if (naglowki2[i + 2] != "Kwasy tłuszczowe nasycone [g]" && naglowki2[i + 2] != "Sód [mg]")
                                    {
                                        t2.Rows[0].Cells[i + licznik2].Paragraphs[0].Append(naglowki2[i + 2])
                                        .Font("Times New Roman")
                                        .FontSize(9)
                                        .Color(Color.Black);
                                    }
                                ...
                                if (columns2 == 10)
                                {
                                    if (i == 1)
                                    {
                                        dodatek = (Math.Round((sum[i] * MainWindow.przelicznik_Bialko * 100.0) / sum[0], 2)).ToString();
                                        dodatek = "\r\n(" + dodatek + " %)";
                                    }
                                    if (i == 2)
                                    {
                                        dodatek = (Math.Round((sum[i] * MainWindow.przelicznik_Tluszcze * 100.0) / sum[0], 2)).ToString();
                                        dodatek = "\r\n(" + dodatek + " %)";
                                    }
                                    if (i == 5)
                                    {
                                        dodatek = (Math.Round((sum[i] * MainWindow.przelicznik_Weglowodany * 100.0) / sum[0], 2)).ToString();
                                        dodatek = "\r\n(" + dodatek + " %)";
                                    }
                                }
                                else
                                ...
                                if (i + licznik3 < t2.Rows[0].Cells.Count)
                                {
                                    ...
                                    if (naglowki2[i + 2] != "Kwasy tłuszczowe nasycone [g]" && naglowki2[i + 2] != "Sód [mg]")
                                    {
                                        ...
                                        t2.Rows[1].Cells[i + licznik3].Paragraphs[0].Append(Math.Round(sum[i], 2).ToString() + dodatek)
                                            .Font("Times New Roman")
                                            .FontSize(9)
                                            .Color(Color.Black);
                                    }
                            ...
                            else if (suma_kalorie[1] == 0 && suma_kalorie[3] != 0) { col = 4; nag = new string[4] { "Śniadanie", "Obiad", "Podwieczorek", "Kolacja" }; }
        ...
        public static void JadlospisDzienny(List<Menu> listaJadlospisow)
        {
            try
            {
                if (listaJadlospisow.Count > 0)
                {
                    ...
                    using (DocX document = DocX.Create(path))
                    {
                        string[] data = listaJadlospisow[0].data.Split(' ');
                        int miesiac = 0;
                        switch(data[1])
                        {
                            case "stycznia":
                        ...
                        string dzienTygodnia = new DateTime(Convert.ToInt32(data[2]), miesiac, Convert.ToInt32(data[0])).DayOfWeek.ToString();
                        string dzienTygodniaPol = "";
                        switch(dzienTygodnia)
                        {
                            case "Monday":
                                dzienTygodniaPol = "Poniedziałek";
                                break;
                            case "Tuesday":
                                dzienTygodniaPol = "Wtorek";
                                break;
                            case "Wednesday":
                                dzienTygodniaPol = "Środa";
                                break;
                            case "Thursday":
                                dzienTygodniaPol = "Czwartek";
                                break;
                            case "Friday":
                                dzienTygodniaPol = "Piątek";
                                break;
                            case "Saturday":
                                dzienTygodniaPol = "Sobota";
                                break;
                            case "Sunday":
                                dzienTygodniaPol = "Niedziela";
                                break;
                        }
                        Paragraph p = document.InsertParagraph();
                        p.Alignment = Alignment.center;
                   ...
                   .Bold();
                       ...
                       .Bold();
                            ...
                            for (int i = 0; i < columns2 - 2; i++)
                            {
                                if (naglowki[i + 2] != "Kwasy tłuszczowe nasycone [g]" && naglowki[i + 2] != "Sód [mg]")
                                {
                                    t2.Rows[0].Cells[i + licznik].Paragraphs[0].Append(naglowki[i + 2])
                                .Font("Times New Roman")
                                .FontSize(9)
                                .Color(Color.Black);

                                    t2.Rows[1].Cells[i + licznik].Paragraphs[0].Append(suma[i].ToString())
                                            .Font("Times New Roman")
                                            .FontSize(9)
                                            .Color(Color.Black);
                                }
        ...
        public static void Dekadowka(string miasto, string dataOd, string dataDo, List<Menu> listaJadlospisow)
        {
            try
            {
                System.IO.Directory.CreateDirectory("Dekadówki/" + miasto);
                List<Diet> listaDiet = HospitalDietManagerApp.DAO.DietsDAO.SelectAll(miasto);
                DateTime dateFrom = Convert.ToDateTime(dataOd);
                DateTime dateTo = Convert.ToDateTime(dataDo);
                foreach (Diet d in listaDiet)
                {
                    string path = @"Dekadówki/" + miasto + "/" + dataOd + "-" + dataDo + ", " + d.nazwa + ".docx";
                    List<Menu> listaJadlospisowDlaDiety = listaJadlospisow.Where(x => x.dieta.nazwa == d.nazwa).Cast<Menu>().ToList();
                    if (listaJadlospisowDlaDiety != null && listaJadlospisowDlaDiety.Count > 0)
                    {
                        using (DocX document = DocX.Create(path))
                        {
                            ...
                            for (DateTime data = dateFrom; data <= dateTo; data = data.AddDays(1))
                            {
                                ...
                                Menu j = HospitalDietManagerApp.DAO.MenusDAO.SelectAll(dt, miasto, d.nazwa);
                        ...
                        .Color(Color.Black);
                                ...
                                else
                                {
                                    if (rows == 6)
                                    {
                                        t.Rows[1].Cells[licznik].Paragraphs[0].Append(" - ").Font("Times New Roman")
                            .FontSize(9)
                            .Color(Color.Black);
                                        t.Rows[2].Cells[licznik].Paragraphs[0].Append(" - ").Font("Times New Roman")
                            .FontSize(9)
                            .Color(Color.Black);
                                        t.Rows[3].Cells[licznik].Paragraphs[0].Append(" - ").Font("Times New Roman")
                        .FontSize(9)
                        .Color(Color.Black);
                                        t.Rows[4].Cells[licznik].Paragraphs[0].Append(" - ").Font("Times New Roman")
                        .FontSize(9)
                        .Color(Color.Black);
                                        t.Rows[5].Cells[licznik].Paragraphs[0].Append(" - ").Font("Times New Roman")
                        .FontSize(9)
                        .Color(Color.Black);
                                    }
                                    else if (rows == 5)
